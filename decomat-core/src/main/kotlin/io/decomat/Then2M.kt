...
fun <P1: Pattern0<R1>, R1, M1, P2: Pattern2M<P21, M2, P22, R21, R22, R2>, P21: Pattern<R21>, R21, M2, P22: Pattern<R22>, R22, R2, R> case(pat: Pattern2M<P1, M1, P2, R1, R2, R>) = Then0M(pat, {true})

class Then0M<P1: Pattern0<R1>, R1, M1, P2: Pattern2M<P21, M2, P22, R21, R22, R2>, P21: Pattern<R21>, R21, M2, P22: Pattern<R22>, R22, R2, R>(
  ...
  inline fun thenIf(crossinline f: (R1, M1, Components2M<R21, M2, R22>) -> Boolean) =
    Then0M(pat) { v -> useComponents(v, { c1, m, c2 -> f(c1, m, c2) }) }

  inline fun thenIfThis(crossinline f: R.(R1, M1, Components2M<R21, M2, R22>) -> Boolean) =
    Then0M(pat) { v -> useComponents(v, { c1, m1, c2 -> f(v, c1, m1, c2) }) }
...
fun <P1: Pattern1<P11, R11, R1>, P11: Pattern<R11>, R11, R1, M1, P2: Pattern2M<P21, M2, P22, R21, R22, R2>, P21: Pattern<R21>, R21, M2, P22: Pattern<R22>, R22, R2, R> case(pat: Pattern2M<P1, M1, P2, R1, R2, R>) = Then1M(pat, {true})

class Then1M<P1: Pattern1<P11, R11, R1>, P11: Pattern<R11>, R11, R1, M1, P2: Pattern2M<P21, M2, P22, R21, R22, R2>, P21: Pattern<R21>, R21, M2, P22: Pattern<R22>, R22, R2, R>(
  override val pat: Pattern2M<P1, M1, P2, R1, R2, R>,
  override val check: (R) -> Boolean
): Stage<Pattern2M<P1, M1, P2, R1, R2, R>, R> {
  ...
  inline fun thenIf(crossinline f: (Components1<R11>, M1, Components2M<R21, M2, R22>) -> Boolean) =
    Then1M(pat) { v -> useComponents(v, { c1, m, c2 -> f(c1, m, c2) }) }

  inline fun thenIfThis(crossinline f: R.(Components1<R11>, M1, Components2M<R21, M2, R22>) -> Boolean) =
    Then1M(pat) { v -> useComponents(v, { c1, m, c2 -> f(v, c1, m, c2) }) }

  inline fun <O> then(crossinline f: (Components1<R11>, M1, Components2M<R21, M2, R22>) -> O) =
    StageCase(pat, check) { v -> useComponents(v, { c1, m, c2 -> f(c1, m, c2) }) }
}

fun <P1: Pattern2<P11, P12, R11, R12, R1>, P11: Pattern<R11>, R11, P12: Pattern<R12>, R12, R1, M1, P2: Pattern2M<P21, M2, P22, R21, R22, R2>, P21: Pattern<R21>, R21, M2, P22: Pattern<R22>, R22, R2, R> case(pat: Pattern2M<P1, M1, P2, R1, R2, R>) = Then2M(pat, {true})

class Then2M<P1: Pattern2<P11, P12, R11, R12, R1>, P11: Pattern<R11>, R11, P12: Pattern<R12>, R12, R1, M1, P2: Pattern2M<P21, M2, P22, R21, R22, R2>, P21: Pattern<R21>, R21, M2, P22: Pattern<R22>, R22, R2, R>(
  override val pat: Pattern2M<P1, M1, P2, R1, R2, R>,
  override val check: (R) -> Boolean
): Stage<Pattern2M<P1, M1, P2, R1, R2, R>, R> {
  ...
  inline fun thenIf(crossinline f: (Components2<R11, R12>, M1, Components2M<R21, M2, R22>) -> Boolean) =
    Then2M(pat) { v -> useComponents(v, { c1, m, c2 -> f(c1, m, c2) }) }

  inline fun thenIfThis(crossinline f: R.(Components2<R11, R12>, M1, Components2M<R21, M2, R22>) -> Boolean) =
    Then2M(pat) { v -> useComponents(v, { c1, m, c2 -> f(v, c1, m, c2) }) }
...
fun <P1: Pattern2M<P11, M1, P12, R11, R12, R1>, P11: Pattern<R11>, R11, M1, P12: Pattern<R12>, R12, R1, P2: Pattern0<R2>, R2, M2, R> case(pat: Pattern2M<P1, M2, P2, R1, R2, R>) = ThenM0(pat, {true})

class ThenM0<P1: Pattern2M<P11, M1, P12, R11, R12, R1>, P11: Pattern<R11>, R11, M1, P12: Pattern<R12>, R12, R1, P2: Pattern0<R2>, R2, M2, R>(
  ...
  inline fun thenIf(crossinline f: (Components2M<R11, M1, R12>, M2, R2) -> Boolean) =
    ThenM0(pat) { v -> useComponents(v, { c1, m, c2 -> f(c1, m, c2) }) }

  inline fun thenIfThis(crossinline f: R.(Components2M<R11, M1, R12>, M2, R2) -> Boolean) =
    ThenM0(pat) { v -> useComponents(v, { c1, m, c2 -> f(v, c1, m, c2) }) }
...
fun <M1: Pattern2M<P11, M1, P12, R11, R12, R1>, P11: Pattern<R11>, R11, P12: Pattern<R12>, R12, R1, P2: Pattern1<P21, R21, R2>, P21: Pattern<R21>, R21, R2, M2, R> case(pat: Pattern2M<M1, M2, P2, R1, R2, R>) = ThenM1(pat, {true})

class ThenM1<P1: Pattern2M<P11, M1, P12, R11, R12, R1>, P11: Pattern<R11>, R11, M1, P12: Pattern<R12>, R12, R1, P2: Pattern1<P21, R21, R2>, P21: Pattern<R21>, R21, R2, M2, R>(
  override val pat: Pattern2M<P1, M2, P2, R1, R2, R>,
  override val check: (R) -> Boolean
): Stage<Pattern2M<P1, M2, P2, R1, R2, R>, R> {
  ...
  inline fun thenIf(crossinline f: (Components2M<R11, M1, R12>, M2, Components1<R21>) -> Boolean) =
    ThenM1(pat) { v -> useComponents(v, { c1, m, c2 -> f(c1, m, c2) }) }

  inline fun thenIfThis(crossinline f: R.(Components2M<R11, M1, R12>, M2, Components1<R21>) -> Boolean) =
    ThenM1(pat) { v -> useComponents(v, { c1, m, c2 -> f(v, c1, m, c2) }) }

  inline fun <O> then(crossinline f: (Components2M<R11, M1, R12>, M2, Components1<R21>) -> O) =
    StageCase(pat, check) { v -> useComponents(v, { c1, m, c2 -> f(c1, m, c2) }) }
}

class ThenM2<P1: Pattern2M<P11, M1, P12, R11, R12, R1>, P11: Pattern<R11>, R11, M1, P12: Pattern<R12>, R12, R1, P2: Pattern2<P21, P22, R21, R22, R2>, P21: Pattern<R21>, R21, P22: Pattern<R22>, R22, R2, M2, R>(
  override val pat: Pattern2M<P1, M2, P2, R1, R2, R>,
  override val check: (R) -> Boolean
): Stage<Pattern2M<P1, M2, P2, R1, R2, R>, R> {
  ...
  inline fun thenIf(crossinline f: (Components2M<R11, M1, R12>, M2, Components2<R21, R22>) -> Boolean) =
    ThenM2(pat) { v -> useComponents(v, { c1, m, c2 -> f(c1, m, c2) }) }

  inline fun thenIfThis(crossinline f: R.(Components2M<R11, M1, R12>, M2, Components2<R21, R22>) -> Boolean) =
    ThenM2(pat) { v -> useComponents(v, { c1, m, c2 -> f(v, c1, m, c2) }) }
