...
// FlatMap(IsAny, Is<Map>).then { a, (b, c) -> ... }
// FlatMap_M(IsAny, Map_M(IsAny, IsAny, Is<Map>)).then { a, (b, c) -> ... }
// of Map.Is
...
//class FlatMap_Is: Is<FlatMap>(Typed<FlatMap>())
