...
// TODO thenIfBoth
fun <P1: Pattern0<R1>, P2: Pattern0<R2>, R1, R2, R, O> Pattern2<P1, P2, R1, R2, R>.thenBoth(f: R.() -> (R1, R2) -> O): O = TODO()
...
@JvmName("then00")
fun <P1: Pattern0<R1>, P2: Pattern0<R2>, R1, R2, R, O> Pattern2<P1, P2, R1, R2, R>.then(f: (R1, R2) -> O): Case<O> = TODO()
@JvmName("then02")
